...
describe('UploadHandler test suite', () => {
  ...
  describe('handleFileBytes', () => {
    ...
    test('given message timerDelay as 2 seconds it should emit only two messages during 4 seconds period', async () => {
      jest.spyOn(ioObj, ioObj.emit.name)
  ...
  describe('canExecute', () => {
    ...
    test('should return false when time is earlier than specified delay', () => {
